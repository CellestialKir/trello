...
export const addBoard = (newBoard) => async (dispatch) => {
    ...
    const response = await fetch("https://682dc10e4fae1889475763c8.mockapi.io/boards", {
        method: "POST",
        headers: {
...
export const deleteBoard = (id) => async (dispatch) => {
    const response = await fetch(`https://682dc10e4fae1889475763c8.mockapi.io/boards/${id}`, {
        method: "DELETE",
    });
