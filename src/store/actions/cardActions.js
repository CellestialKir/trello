...
export const addCard = (newCard) => async (dispatch) => {
    const response = await fetch("https://682dc10e4fae1889475763c8.mockapi.io/task", {
        method: "POST",
        headers: {
...
export const deleteCard = (id) => async (dispatch) => {
    const response = await fetch(`${"https://682dc10e4fae1889475763c8.mockapi.io/task"}/${id}`, {
        method: "DELETE",
    });
...
export const reorderCards = (reorderedCards) => async (dispatch) => {
  try {
    ...
    for (const card of reorderedCards) {
      const response = await fetch(`${"https://682dc10e4fae1889475763c8.mockapi.io/task"}/${card.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
